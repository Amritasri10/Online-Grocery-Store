...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$loginid 		= $configs['email_config']['email_loginid'];
	$password 		= $configs['email_config']['email_password'];
	$smtpserver 	= $configs['email_config']['email_smtpserver'];
	$smtpport 		= $configs['email_config']['email_smtpport'];
	$mailsender 	= $configs['email_config']['email_sender'];
	$companyname	= $configs['email_config']['email_sender'];
	$email_security = $configs['email_config']['email_security'];
	$facebook = $configs['contact']['facebook'];
	$twitter = $configs['contact']['twitter'];
	$youtube = $configs['contact']['youtube'];
	$linkedin = $configs['contact']['linkedin'];
	$companyaddress  = $configs['contact']['companyaddress'];
	$contactno = $configs['contact']['contactno'];
	$url = $configs['contact']['url'];
	...
	try
	{
		...
		$mail->SMTPSecure = $email_security; // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
		$mail->Port       = $smtpport;
